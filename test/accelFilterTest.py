...
def create3plots(yMin,yMax,yticks,plotData):
...
ymin = -1
ymax = 1
yTicks = .1 # spacing per ticks
accelPlotData = [axData, ayData, azData]

ayHandle, figAccel = create3plots(ymin,ymax,yTicks,accelPlotData)
...
vyHandle, figVelo = create3plots(ymin,ymax,yTicks,veloPlotData)
...
dyHandle, figDisp = create3plots(ymin,ymax,yTicks,dispPlotData)
